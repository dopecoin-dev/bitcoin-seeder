...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Dopecoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.dopecoin.com", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("37.120.190.76", 40420), true);
    db.Add(CService("37.120.186.85", 40420), true);
    db.Add(CService("188.68.52.172", 40420), true);
  }
  do {
